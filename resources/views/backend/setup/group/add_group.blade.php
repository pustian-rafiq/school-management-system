    ...
    <!-- Basic Forms -->
     <div class="box">
       <div class="box-header with-border">
         ...
         <a class="btn btn-rounded btn-success" style="float: right" href="{{  route('student.group.view')}}">View Student Group </a> 
       </div>
       <!-- /.box-header -->
       <div class="box-body">
         <div class="row">
                    ...
                    <div class="row">
                        <div class="col-6">		
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="name" class="form-control" required   placeholder="Enter your group name"> 
                                </div>
                                @error('name') 
