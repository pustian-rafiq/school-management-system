                    ...
                    <tbody>
                       ...
                       @foreach($feeCategories as $key => $feeCategory)
                        <tr>
                            ...
                            <td style="width: 20%">
                              <a href="{{ route('student.fee.category.edit',$feeCategory->id) }}" class="btn btn-success">Edit</a>
                              <a href="{{ route('student.fee.category.delete',$feeCategory->id) }}" class="btn btn-danger" id="delete">Delete</a>
                            </td>
                        </tr>
                          @endforeach 
                    </tbody>
