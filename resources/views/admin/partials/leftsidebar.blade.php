...
<aside class="main-sidebar">
	...
	@endif	  
        <li class="treeview {{ ($prefix == '/profile') ? 'active' : ''  }} ">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ route('profile.view') }}"><i class="ti-more"></i>View Your Profile</a></li>
        ...
        <li class="treeview {{ ($prefix == '/setups') ? 'active' : ''  }} ">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="{{ route('student.fee.category.view') }}" ><i class="ti-more"></i>Fee Category</a></li>
            <li><a href="{{ route('student.fee.amount.view') }}" ><i class="ti-more"></i>Fee Amount</a></li>
        ...
        <li class="treeview {{ ($prefix == '/students') ? 'active' : ''  }} ">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="{{ route('student.reg.generate.view') }}"><i class="ti-more"></i>Registration Fee</a></li>
            <li><a href="{{ route('student.monthly.fee.view') }}"><i class="ti-more"></i>Monthly Fee</a></li>
            <li><a href="{{ route('student.exam.fee.view') }}"><i class="ti-more"></i>Exam Fee</a></li>
        ...
        <li class="treeview {{ ($prefix == '/employees') ? 'active' : ''  }} ">
          <a href="#">
            <i data-feather="mail"></i>Employee Management</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-right pull-right"></i>
            </span>
          </a>
